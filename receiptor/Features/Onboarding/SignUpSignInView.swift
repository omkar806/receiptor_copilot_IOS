    ...
    var body: some View {
        ...
        NavigationStack {
            ZStack {
                ...
                NavigationLink(destination:HomeScreen(user_name:self.user_name) , tag:"DataUsageView" , selection: $selection
                ){EmptyView()}
                        ...
                        Button{
                             let _ = SignlogInWithGoogle{
                                ...
                                if let token = access_token{
                                    ...
                                    Task{
                                        do {
                                            let Ch = await checkuser(idToken: self.idToken, access_token: self.access_token_, user_name: self.user_name)
                                            if Ch {
